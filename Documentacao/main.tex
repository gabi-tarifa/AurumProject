...
\section{Introdução}
    ...
    A educação fincanceira é um direito essencial do cidadão e fundamental para o crescimento social e pessoal, apesar de sua importância, boa parte da população enfrenta dificuldades para acessar a informação, seja por fatores financeiros, seja a falta de incentivo, ou até mesmo barreiras de entendimento.
    
    Facilmente pode-se observar a falta de conhecimento de conceitos básicos de finanças, segundo o Instituto Brasileiro de Geografia e Estatística (IBGE), o índice de pobreza caiu de 67,7 milhões de pessoas para 59,0 milhões, um grande avanço, porém continua sendo preocupante a larga quantidade de pessoas que se mantém nas margens da sociedade. 
    
     Segundo \citeonline{BRUNA} um exemplo presente na sociedade brasileira é o cartão de crédito, que facilmente pode ocorrer a perda do controle dos gastos, derivado da precariedade de instruções por conta da facilidade do usufruto do cartão. Sem contar que a população continua se individando com os juros das parcelas, que são escolhidas as menores possíveis para poderem pagar menos mensalmente, mas na realidade acabam pagando muito mais do que o valor inicial. 
